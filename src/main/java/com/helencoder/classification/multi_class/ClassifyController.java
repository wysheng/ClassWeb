...
//import org.apache.spark.mllib.com.helencoder.classification.LogisticRegressionModel;
//import org.apache.spark.mllib.com.helencoder.classification.LogisticRegressionWithLBFGS;
//import org.apache.spark.mllib.evaluation.MulticlassMetrics;
//import org.apache.spark.mllib.feature.HashingTF;
//import org.apache.spark.mllib.linalg.Matrix;
//import org.apache.spark.mllib.regression.LabeledPoint;
//import org.apache.spark.mllib.linalg.Vector;
//import org.apache.spark.mllib.com.helencoder.util.MLUtils;
//import org.apache.tools.ant.taskdefs.Java;
//import scala.Tuple2;
import com.helencoder.util.FileUtil;
...
//
//        // 加载训练模型
//        LogisticRegressionModel com.helencoder.model = LogisticRegressionModel.load(sc, "data/com.helencoder.model/LogisticRegressionModelBy1000000/");
//
//        // 待预测数据模型构建
//        final HashingTF tf = new HashingTF(1000000);
//        Vector features = tf.transform(Arrays.asList(content.split(" ")));
//
//        Double predictedClass = com.helencoder.model.predict(features);
//        // 获取类别配置
...
//        JavaRDD<LabeledPoint> newsClassDataRDD = newsDataRDD.com.helencoder.filter(
...
//
//        // Run training algorithm to build the com.helencoder.model.
//        LogisticRegressionModel com.helencoder.model = new LogisticRegressionWithLBFGS()
//                .setNumClasses(6)
//                .run(training.rdd());
//
//        // Compute raw scores on the test set.
//        JavaPairRDD<Object, Object> predictionAndLabels = test.mapToPair(p -> new Tuple2<>(com.helencoder.model.predict(p.features()), p.label()));
//
...
//
//        //LogisticRegressionModel sameModel = LogisticRegressionModel.load(sc, "data/com.helencoder.model/LogisticRegressionModelBy10000/");
//
//        // 累加器
//        //final Accumulator<Integer> correctCount = sc.accumulator(0);
//        test.foreach(r -> {
//            System.out.println("当前文章类别为: " + r.label() + "\t预测类别为: " + com.helencoder.model.predict(r.features()));
//        });
//
//        // Overall statistics
...
//
//        // Save and load com.helencoder.model
//        com.helencoder.model.save(sc, "data/com.helencoder.model/LogisticRegressionModelBy1000000/");
//
//        // $example off$
//
//        sc.stop();
